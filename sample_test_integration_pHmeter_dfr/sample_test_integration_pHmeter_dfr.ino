...
#define Offset 1.86            //deviation compensate
#define LED 47
...
{  
  ...
  if(millis() - printTime2 > printInterval2)   //Every 800 milliseconds, print a numerical, convert the state of the LED indicator
  {
